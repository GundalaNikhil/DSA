...
```java
class Solution {
    public long maxReward(int n, int p, int[][] rewards) {
        // Implement here
        return 0;
    }
}
...
```python
class Solution:
    def maxReward(self, n: int, p: int, rewards: list[list[int]]) -> int:
        # Implement here
        return 0
```
...
class Solution {
public:
    long long maxReward(int n, int p, vector<vector<int>>& rewards) {
        // Implement here
        return 0;
    }
};
