...
public class Solution {
    public long sumVisitedValues(int n, int[][] nodes) {
        // Your code here
        return 0;
    }
}
...
```python
class Solution:
    def sumVisitedValues(self, n: int, nodes: list[list[int]]) -> int:
        # Your code here
        return 0
```
...
class Solution {
public:
    long long sumVisitedValues(int n, vector<vector<int>>& nodes) {
        // Your code here
        return 0;
    }
};
