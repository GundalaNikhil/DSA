...
public class Solution {
    public long calculateDelayedValue(int n, long[][] nodes) {
        // Your code here
        return 0;
    }
}
...
```python
class Solution:
    def calculateDelayedValue(self, n: int, nodes: list[list[int]]) -> int:
        # Your code here
        return 0
```
...
class Solution {
public:
    long long calculateDelayedValue(int n, vector<vector<long long>>& nodes) {
        // Your code here
        return 0;
    }
};
