...
public class Solution {
    public long calculateRootCost(int n, long[][] nodes) {
        // Your code here
        return 0;
    }
}
...
```python
class Solution:
    def calculateRootCost(self, n: int, nodes: list[list[int]]) -> int:
        # Your code here
        return 0
```
...
class Solution {
public:
    long long calculateRootCost(int n, vector<vector<long long>>& nodes) {
        // Your code here
        return 0;
    }
};
