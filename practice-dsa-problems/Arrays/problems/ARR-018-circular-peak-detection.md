...
```java
class Solution {
    public int countCircularPeaks(int n, int[] a) {
        // Implement here
        return 0;
    }
}
...
```python
class Solution:
    def countCircularPeaks(self, n: int, a: list[int]) -> int:
        # Implement here
        return 0
```
...
class Solution {
public:
    int countCircularPeaks(int n, vector<int>& a) {
        // Implement here
        return 0;
    }
};
