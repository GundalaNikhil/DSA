...
class Solution {
    ...
    private Map<String, int[]> metadata = new HashMap<>(); // word -> [frequency, lastUsed]
...
def autocomplete(words: List[tuple], prefix: str, current_time: int, D: int, k: int) -> List[str]:
    """
    words: list of (word, frequency, timestamp) tuples
    Returns: top k words by decayed score
    """
    # Your implementation here
    pass
...
def main():
    ...
    result = autocomplete(words, prefix, current_time, D, k)
    print(result)
