...
def longest_word_with_k_prefixes(words: List[str], k: int) -> str:
    """
    Find longest word with at least k prefixes in dictionary
    """
    # Your implementation here
    pass
...
def main():
    ...
    result = longest_word_with_k_prefixes(words, k)
...
function longestWordWithKPrefixes(words, k) {
  // Your implementation here
  return "";
}
...
rl.on("line", (line) => {
  ...
  const result = longestWordWithKPrefixes(words, k);
  console.log(result);
});
```
