...
class Solution {
    public String longestPalindromeWithWildcard(String s) {
        // Implement here
        return "";
    }
}
...
class Main {
    public static void main(String[] args) {
        ...
        if (sc.hasNext()) {
            ...
            System.out.println(solution.longestPalindromeWithWildcard(s));
        }
        sc.close();
    }
}
...
def solve():
    ...
    solution = Solution()
    print(solution.longest_palindrome_with_wildcard(s))

class Solution:
    def longest_palindrome_with_wildcard(self, s: str) -> str:
        # Implement here
        return ""
...
class Solution {
public:
    string longestPalindromeWithWildcard(string s) {
        // Implement here
        return "";
    }
};
...
int main() {
    ...
    if (cin >> s) {
        Solution sol;
        cout << sol.longestPalindromeWithWildcard(s) << endl;
    }
...
class Solution {
  longestPalindromeWithWildcard(s) {
    // Implement here
    return "";
  }
}
...
rl.on("line", (line) => {
  ...
  console.log(sol.longestPalindromeWithWildcard(s));
});
```
