...
public class Solution {
    public int[] orientationTriplets(int[] arr) {
        // Implementation here
        return new int[0];
    }
}
...
### Python
```python
def orientationTriplets(arr: List[int]) -> List[int]:
    """
    Solve the problem.
...
class Solution {
public:
    vector<int> orientationTriplets(vector<int>& arr) {
        // Implementation here
        return {};
    }
};
...
### Question 1
**What is the optimal time complexity for solving 'Orientation of Triplets'?**
