...
Wait, this is node-disjoint. For edge-disjoint, greedy often works better but still can fail in complex "trap" topologies where flow redirection (back-edges) is needed. Max Flow handles this redirection.
