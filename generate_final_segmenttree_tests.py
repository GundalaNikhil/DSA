#!/usr/bin/env python3
"""
Final correct test cases for SegmentTree problems based on exact solution specs
"""
...
def generate_seg001_tests():
    ...
    # Test 1: Basic with queries and updates
    tests.append({
        'input': "3 5 1000\n1 2 3\nQUERY 0 2\nUPDATE 1 5\nQUERY 0 2\nUNDO 1\nQUERY 0 2",
        'output': "6\n9\n6"
    })
    ...
    # Test 3: Negative values with modulo
    tests.append({
        'input': "3 3 1000\n-5 10 -3\nQUERY 0 2\nUPDATE 1 15\nQUERY 0 2",
        'output': "2\n20"
    })
...
def generate_seg004_tests():
    ...
    # Test 1: Basic SET operations (all 2 params)
    tests.append({
        'input': "4 3\n2 1 3 0\nSET 0 1\nSET 1 0\nSET 2 2",
        'output': "1\n0\n2"
    })
...
def generate_seg010_tests():
    """Range GCD Skip Zones - with forbidden indices"""
    tests = []

    # Test 1: GCD, QUERY, TOGGLE
    tests.append({
        'input': "5 4\n12 18 24 36 48\n0\nGCD 0 4\nGCD 1 3\nTOGGLE 2\nGCD 0 4",
        'output': "6\n6\n12"
    })

    # Test 2: Single element with no forbidden
    tests.append({
        'input': "1 2\n42\n0\nGCD 0 0\nTOGGLE 0",
        'output': "42"
    })
...
def generate_seg014_tests():
    ...
    # Test 1: QUERY and SETPREFIX (both 2 params)
    tests.append({
        'input': "5 3\n3 1 4 1 5\nQUERY 0 4 2\nSETPREFIX 2 2\nQUERY 0 4 2",
        'output': "1\n2"
    })
...
def generate_seg016_tests():
    """Dynamic Connectivity Offline (no array)"""
    tests = []

    # Test 1: ADD, QUERY, REMOVE
    tests.append({
        'input': "4 5\nADD 0 1\nQUERY 0 1\nADD 1 2\nQUERY 0 2\nREMOVE 0 1",
        'output': "YES\nYES\nNO"
    })

    # Test 2: No edges initially
    tests.append({
        'input': "3 2\nQUERY 0 1\nQUERY 1 2",
        'output': "NO\nNO"
    })
...
def main():
    ...
    print("=" * 60)
    print("GENERATING FINAL SEGMENTTREE TEST CASES")
    print("=" * 60)
