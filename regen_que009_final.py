#!/usr/bin/env python3
"""Regenerate QUE-009 testcases with fixed solution"""
import subprocess
import yaml
...
solution_path = '/Users/nikhilgundala/Desktop/NTB/DSA/dsa-problems/Queues/solutions/python/QUE-009-customer-service-queue.py'
...
with open('/Users/nikhilgundala/Desktop/NTB/DSA/dsa-problems/Queues/testcases/QUE-009-battery-lab-first-negative.yaml', 'w') as f:
    yaml.dump(new_data, f, default_flow_style=False, sort_keys=False)

print("\n✓ Regenerated QUE-009 testcases")
