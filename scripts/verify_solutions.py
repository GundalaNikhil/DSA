...
PROBLEMS_DIR = os.path.join(DSA_ROOT, "dsa-problems", "AdvancedGraphs")
...
def verify(problem_id, languages):
    ...
    for lang in languages:
        ...
        for i, t in enumerate(tests):
            ...
            if "AGR-012" in problem_id or "AGR-003" in problem_id:
...
def main():
    ...
    parser.add_argument('problem_id', help="Problem ID (e.g. AGR-001)")
