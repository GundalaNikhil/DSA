...
PROBLEMS_DIR = os.path.join(DSA_ROOT, "dsa-problems", "Hashing")
...
def verify(problem_id, languages):
    ...
    for lang in languages:
        ...
        # print input for debugging
                if "HSH-014" in problem_id and not ok:
                     print(f"DEBUG INPUT: {repr(t['input'])}")
...
def main():
    ...
    parser.add_argument('problem_id', help="Problem ID (e.g. HSH-001)")
