...
At the bottom, show a ranking arrow pointing to "he" (1st), "hello" (2nd), "helium" (3rd). Use marker-on-whiteboard aesthetic - bold simple lines, blue and black colors, clean boxes, hand-drawn arrows. Add currentTime=10, D=10 as parameters at top.""",
    ...
    "test-walkthrough": """Simple hand-drawn test case walkthrough diagram showing the autocomplete algorithm execution. At top, show input parameters in a dashed box: "prefix='he', currentTime=10, D=10, k=2". Below, draw the process in 3 steps as simple sketched boxes:
...
def process_tri_001():
    ...
    for image_name, prompt in TRI_001_PROMPTS.items():
        ...
        local_path = temp_dir / f"{image_name}.png"
    ...
    if image_urls:
        ...
        print(f"\n✗ No images were successfully generated for {problem_id}")
...
def main():
    print("=" * 60)
    print("Editorial Image Generation Pipeline")
    print("=" * 60)
    print()
