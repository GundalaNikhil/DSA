#!/usr/bin/env python3
"""
Test script for Trees module solutions against YAML test cases.
"""
...
def load_test_cases(problem_id):
    ...
    yaml_path = f"dsa-problems/Trees/testcases/{problem_id}-*.yaml"
    import glob
...
def main():
    """Test all Trees solutions."""
    results = {}
    total_passed = 0
    total_tests = 0

    for problem_num in range(1, 19):
        problem_id = f"TRE-{problem_num:03d}"
        solution_path = f"dsa-problems/Trees/solutions/python/{problem_id}-*.py"
